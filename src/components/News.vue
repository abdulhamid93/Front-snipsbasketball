<template>
    <div>
        ...
        >
            <img class="main-img" :src="hero_img" style="opacity: 0" />
        </div>
    ...
    <section class="section next-draw-section section-new">
        <div>
            <h3 class="next-draw-h3"> For Enquiries <a target="_blank" href="https://wa.me/+96176888945">76/888945 </a></h3>
        </div>
    </section>
                    ...
                    <div class="team-bar" style="position: relative">
                        <div class="bar">
                            <div
                                ...
                                :style="{
                                    height:
                                        calculatePercentage(team.total) * 1.5 +
                                        '%',
                                    position: 'relative',
                            ...
                            ></div>
                            <span class="total"
                                >{{ calculatePercentage(team.total) }}%</span
                            >
                        </div>
        ...
        <div class="">
            <div class="row p-0 m-0">
                <div class="col-md-4 col-sm-6 main-logo-img">
                    <img
                        src="https://app.snipsbasketball.com/storage/general/logo-1.png"
                    />
                    <div class="hero-text-box mobile">
                        <img
                            class="mobile-vote"
                            src="./../assets/img/vote-2.png"
                        />
    ...
    <div class="modal" v-if="openPopupInC2">
        <div class="modal-content">
            ...
            <h2 class="p-title">
                <img
                    src="https://app.snipsbasketball.com/storage/general/snips-logo.png"
                    alt="snipsbasketball"
                    height="80"
                />
                <span style="margin-left: 20px; color: #df2020"
                    >live Results:</span
                >
            </h2>
            <!-- <table>
...
export default {
    ...
    methods: {
        ...
        calculatePercentage(total) {
            ...
            if (total != 0) return ((total / totalPoints) * 100).toFixed(0);
            else return 0;
        },
        sortTeamsByTotal() {
...
.next-draw-section{display:none;}
.next-draw-section.section-new{
display:block;
}
.team-bar .bar {
    min-height: 200px;
